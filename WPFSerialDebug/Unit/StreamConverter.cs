...
public class StreamConverter
{
    ...
    /// <returns></returns>
    public static byte[] AsciiStringToArray(Encoding encoding, string value, int startIndex, int length)
    {
        try
        {
    ...
    /// <param name="value">要转换的数组</param>
    /// <returns></returns>
    public static byte[] AsciiStringToArray(Encoding encoding, string value)
    {
    ...
    /// <param name="length">要转换的长度</param>
    /// <returns></returns>
    public static string ArrayToAsciiString(Encoding encoding, byte[] value, int startIndex, int length)
    {
        try
        {
            //Encoding code = System.Text.Encoding.GetEncoding("UTF-8");
    ...
    /// <param name="value">要转换的数组</param>
    /// <returns></returns>
    public static string ArrayToAsciiString(Encoding encoding, byte[] value)
    {
        if (value != null)
    ...
    /// <param name="length">要转换的长度</param>
    /// <returns></returns>
    public static byte[] BinaryStringToArray(string value, int startIndex, int length)
    {
        try
        {
    ...
    /// <param name="value">要转换的数组</param>
    /// <returns></returns>
    public static byte[] BinaryStringToArray(string value)
    {
    ...
    /// <param name="length">要转换的长度</param>
    /// <returns></returns>
    public static string ArrayToBinaryString(byte[] value, int startIndex, int length)
    {
        try
        {
    ...
    /// <param name="value">要转换的数组</param>
    /// <returns></returns>
    public static string ArrayToBinaryString(byte[] value)
    {
        if (value != null)
    ...
    /// <param name="length">要转换的长度</param>
    /// <returns></returns>
    public static byte[] OctalStringToArray(string value, int startIndex, int length)
    {
        try
        {
            List<byte> list = new List<byte>();
    ...
    /// <param name="value">要转换的数组</param>
    /// <returns></returns>
    public static byte[] OctalStringToArray(string value)
    {
    ...
    /// <param name="length">要转换的长度</param>
    /// <returns></returns>
    public static string ArrayToOctalString(byte[] value, int startIndex, int length)
    {
        try
        {
            StringBuilder sb = new StringBuilder();
    ...
    /// <param name="value">要转换的数组</param>
    /// <returns></returns>
    public static string ArrayToOctalString(byte[] value)
    {
        if (value != null)
    ...
    /// <param name="length">要转换的长度</param>
    /// <returns></returns>
    public static byte[] DecimalStringToArray(string value, int startIndex, int length)
    {
        try
        {
            List<byte> list = new List<byte>();
    ...
    /// <param name="value">要转换的数组</param>
    /// <returns></returns>
    public static byte[] DecimalStringToArray(string value)
    {
    ...
    /// <param name="length">要转换的长度</param>
    /// <returns></returns>
    public static string ArrayToDecimalString(byte[] value, int startIndex, int length)
    {
        try
        {
            StringBuilder sb = new StringBuilder();
    ...
    /// <param name="value">要转换的数组</param>
    /// <returns></returns>
    public static string ArrayToDecimalString(byte[] value)
    {
        if (value != null)
    ...
    /// <param name="value">要转换的数组</param>
    /// <returns></returns>
    public static byte[] HexStringToArray(string value)
    {
    ...
    /// <param name="length">要转换的长度</param>
    /// <returns></returns>
    public static byte[] Base64StringToArray(string value, int startIndex, int length)
    {
        try
        {
    ...
    /// <param name="value">要转换的数组</param>
    /// <returns></returns>
    public static byte[] Base64StringToArray(string value)
    {
    ...
    /// <param name="length">要转换的长度</param>
    /// <returns></returns>
    public static string ArrayToBase64String(byte[] value, int startIndex, int length)
    {
        try
        {
    ...
    /// <param name="value">要转换的数组</param>
    /// <returns></returns>
    public static string ArrayToBase64String(byte[] value)
    {
        if (value != null)
    ...
    private static string _ArrayToString<T>(T[] value, int startIndex, int length, int toBase)
    {
        try
        {
            StringBuilder sb = new StringBuilder();
    ...
    public static string ArrayToString(int[] value, int startIndex, int length, int toBase)
    {
        return _ArrayToString(value, startIndex, length, toBase);
    }

    public static string ArrayToString(int[] value, int startIndex, int length)
    {
        return ArrayToString(value, startIndex, length, 16);
    }

    public static string ArrayToString(int[] value, int toBase)
    {
        if (value != null)
        {
    ...
    public static string ArrayToString(byte[] value, int startIndex, int length, int toBase)
    {
        return _ArrayToString(value, startIndex, length, toBase);
    }

    public static string ArrayToString(byte[] value, int startIndex, int length)
    {
        return ArrayToString(value, startIndex, length, 16);
    }

    public static string ArrayToString(byte[] value, int toBase)
    {
        if (value != null)
        {
            return ArrayToString(value, 0, value.Length, toBase);
